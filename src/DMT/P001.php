...
function editPatientRecordTherapy($patientRecordID) {
	...
	if (access()) {
		...
		if ($query_handle1 != ""){
			...
			print "</td>";
			print "</tr>";
			print "<tr><td valign='top'><b>影像评分:</b></td><td>";
			...
			print "</td>";
			print "</tr>";
            print "<tr><td valign='top'><b>评估和治疗建议:</b></td><td>";
            print "<textarea class='ckeditor' name='therapyDescr3' rows='6' cols='40'>$therapyDescr3</textarea>";
            print "</td>";
            print "</tr>";
/*
